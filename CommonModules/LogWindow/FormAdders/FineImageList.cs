    ...
    public class FineImageList:Component
    {
        ...
        public Image[] Images
        {
            ...
            set
            {
                ...
                {
                    if (i < 10) _images[i] = value[i];
                    else throw new IndexOutOfRangeException("FineImageList는 최대 10개의 이미지만 제공합니다.");
                }
            }
        }
        ...
        {
            if (_count < 9) _images[_count++] = img;
            else throw new IndexOutOfRangeException("FineImageList는 최대 10개의 이미지만 제공합니다.");
            return _count;
        }
        ...
        public int Count
        {
            ...
            set
            {
                ...
                {
                    Add(global::FormAdders.Properties.Resources.led_on);
                }
            }
        }
