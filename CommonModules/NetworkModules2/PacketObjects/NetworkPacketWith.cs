...
namespace NetworkModules
{
    ...
    {
        // constructor
        Dictionary<Enum, int> _startByteOffsetInBuffer = new Dictionary<Enum, int>();
        ...
        List<Enum> _itemListInBuffer = new List<Enum>();
        List<Enum> _itemListForView = new List<Enum>();
        Dictionary<Enum, String> _description = new Dictionary<Enum, string>();
        Dictionary<Enum, String> _category = new Dictionary<Enum, string>();
        Dictionary<Enum, Func<Object,Object>> _setFunc = new Dictionary<Enum, Func<Object,Object>>();
        Dictionary<Enum, Func<Object,Object>> _getFunc = new Dictionary<Enum, Func<Object,Object>>();
        Dictionary<Enum, Func<Int64, Int64>> _setFuncInt = new Dictionary<Enum, Func<Int64, Int64>>();
        Dictionary<Enum, Func<Int64, Int64>> _getFuncInt = new Dictionary<Enum, Func<Int64, Int64>>();
        Dictionary<Enum, Func<Double, Double>> _setFuncFloat = new Dictionary<Enum, Func<Double, Double>>();
        Dictionary<Enum, Func<Double, Double>> _getFuncFloat = new Dictionary<Enum, Func<Double, Double>>();
        Dictionary<Enum, Boolean> _isUnsigned = new Dictionary<Enum, bool>();
        List<String> _names = null; //이 리스트를 초기화하지 말 것. null값이 중요한 값임.
        Dictionary<Type, String> _typeFormat = new Dictionary<Type, string>();
        Dictionary<Enum, String> _enumFormat = new Dictionary<Enum, string>();
        String _nameHeader = ""; //출력되는 이름 앞에 일률적으로 붙을 문자열
        Boolean _unsigned = false;
        Type _itemReturnType = typeof(int);
        Enum _beforeSetEnum;
        Dictionary<Enum, String> _unit = new Dictionary<Enum, string>(); //단위저장
        int _pragma=1;
        int _pragmaStart = 0;
        int _byteCount=0;
        int _bitItemIndex = 0;
        ...
        public virtual void ClonedBy(IClonable cloneBase)
        {
            ...
            {//캐스팅 가능시 하위개체..
                ...
                this._beforeSetEnum = obj._beforeSetEnum;
                this._bitIndex = new Dictionary<Enum, int>(obj._bitIndex);
                this._bitSize = new Dictionary<Enum, int>(obj._bitSize);
                this._category = new Dictionary<Enum, string>(obj._category);
                this._description = new Dictionary<Enum, string>(obj._description);
                this._enumFormat = new Dictionary<Enum, string>(obj._enumFormat);
                this._getFunc = new Dictionary<Enum, Func<object, object>>(obj._getFunc);
                this._setFunc = new Dictionary<Enum, Func<object, object>>(obj._setFunc);
                this._getFuncFloat = new Dictionary<Enum, Func<double, double>>(obj._getFuncFloat);
                this._setFuncFloat = new Dictionary<Enum, Func<double, double>>(obj._setFuncFloat);
                this._getFuncInt = new Dictionary<Enum, Func<long, long>>(obj._getFuncInt);
                this._setFuncInt = new Dictionary<Enum, Func<long, long>>(obj._setFuncInt);
                this._sizeOfItemInBuffer = new Dictionary<Enum, int>(obj._sizeOfItemInBuffer);
                this._startByteOffsetInBuffer = new Dictionary<Enum, int>(obj._startByteOffsetInBuffer);
                this._itemListForView = new List<Enum>(obj._itemListForView);
                this._itemListInBuffer = new List<Enum>(obj._itemListInBuffer);
                this._LSB = new Dictionary<Enum, double>(obj._LSB);
                this._mergedItems = new Dictionary<Enum, List<Enum>>(obj._mergedItems);
                this._mswInMergedItem = new Dictionary<Enum, MswPos>(obj._mswInMergedItem);
                this._nameHeader = obj._nameHeader;
                this._names = obj._names;
                this._parentUnitOfBitItem = new Dictionary<Enum, Enum>(obj._parentUnitOfBitItem);
                this._pragma = obj._pragma;
                this._pragmaStart = obj._pragmaStart;
                this._returnType = new Dictionary<Enum, Type>(obj._returnType);
                this._typeFormat = new Dictionary<Type, string>(obj._typeFormat);
                this._unit = new Dictionary<Enum, string>(obj._unit);
            }
            catch (Exception e)
            {
        ...
        */
        ...
        /// <returns></returns>
        public Type getReturnType(Enum item)
        {
        ...
        public int getVisibleIndex(Enum item)
        {
        ...
        /// <returns></returns>
        public int getStartByteOffset(Enum item)
        {
        ...
        public String getName(Enum item, Boolean isWithUnit = true)
        {
            if (_names != null)
            {
                try
        ...
        public List<String> getNames(Boolean isWithUnit = true)
        {
            ...
            String unit = "";
            foreach (Enum item in _itemListForView)
            {
                if (isWithUnit) unit = (_unit[item].Length > 0) ? " (" + _unit[item] + ")" : "";
        ...
        public List<String> getAllNames(Boolean isWithUnit = true)
        {
            ...
            List<String> names = new List<String>();
            String unit = "";
            foreach (Enum item in _itemListInBuffer)
            {
                if (isWithUnit) unit = (_unit[item].Length > 0) ? " (" + _unit[item] + ")" : "";
                names.Add(_nameHeader + item.ToString() + unit);
            }
        ...
        public void setCategory(Enum item, String category)
        {
        ...
        {
            if (getFunc != null) _getFunc.Add(_beforeSetEnum, getFunc);
            if (setFunc != null) _setFunc.Add(_beforeSetEnum, setFunc);
        }
        ...
        {
            if (getFunc != null) _getFuncInt.Add(_beforeSetEnum, getFunc);
            if (setFunc != null) _setFuncInt.Add(_beforeSetEnum, setFunc);
        }
        ...
        {
            if (getFunc != null) _getFuncFloat.Add(_beforeSetEnum, getFunc);
            if (setFunc != null) _setFuncFloat.Add(_beforeSetEnum, setFunc);
        }
        ...
        public void addItem(Enum enumItem, int roomSize, Boolean isSignedRange, double max, Boolean isVisibleUnit = true, Type returnType = null, String unit = "")
        {
        ...
        public void addItem(Enum enumItem, int roomSize, Boolean isVisibleUnit=true, Type returnType=null, double LSB = 1, String unit="")
        {
            int byteSize = Marshal.SizeOf(typeof(T)) * roomSize;
        ...
        /// 예) {B4},{D4}:{D4}:{B4} - 비트값이 0101010101010101일때 결과: 0101,3:3:0101
        /// .</param>
        public void setFormat(Enum enumItem, String format)
        {
        ...
        {
            setBitItem(bitItem, _bitItemIndex, bitSize, isVisibleUnit, returnType, LSB, unit, parentEnumUnit);
        ...
        public void setMergedItem(Enum mergeUnit, MswPos mswPos, Enum startMerging, int numOfItems, Boolean isVisibleUnit = true, Type returnType = null, double lsb = 1, String unit = "")// params Enum[] mergingUnits)
        {
            //List<Enum> units = new List<Enum>();
            
            //units.AddRange(mergingUnits);
            int startIndex = _itemListInBuffer.IndexOf(startMerging);
            List<Enum> units=_itemListInBuffer.GetRange(startIndex, numOfItems);
        ...
        {
            _description.Add(_beforeSetEnum, description);
        }
        ...
        /// <returns></returns>
        public String getDescription(Enum item)
        {
        ...
        public String getCategory(Enum item)
        {
        ...
        {
            _category.Add(_beforeSetEnum, category);
        }
        ...
        public void swapBuffer(Enum startUnit, int numOfUnits)
        {
            ...
            foreach (Enum key in _itemListInBuffer)
            {
        ...
        #region getWithLsb...s
        Int64 getWithLSBInt(Enum item, Int64 value)
        {
        ...
        Double getWithLSBFloat(Enum item, Int64 value)
        {
        ...
        Boolean getWithLSBBoolean(Enum item, Int64 value)
        {
            if (_getFunc.ContainsKey(item))
            {
                value = (Int64)_getFunc[item].Invoke(value);
        ...
        /// <returns></returns>
        public List<Int64> getValuesInt(IEnumerable<Enum> itemList)
        {
            List<Int64> items = new List<long>();
            foreach (Enum item in itemList)
            {
        ...
        public List<Double> getValuesFloat(IEnumerable<Enum> itemList)
        {
        ...
        public List<String> getValuesAsString(Dictionary<Enum, String> changedValue = null)
        {
        ...
        public String getValueAsFormat(Enum item)
        {
            String format;
        ...
        /// <returns></returns>
        public Int64 getValueInt(Enum item, Endians endian = Endians.Little)
        {
            int startOffset = 0;
            int byteSize = 0;
            int bitStart = -1;
        ...
        public void getValue(Enum item, ref int value,Endians endian = Endians.Little)
        {
            value = (int)getValueInt(item, endian);
        }
        public void getValue(Enum item, ref Int64 value, Endians endian = Endians.Little)
        {
            value = getValueInt(item,  endian);
        }
        public void getValue(Enum item, ref Single value, Endians endian = Endians.Little)
        {
            value = (Single)getValueFloat(item, endian);
        }
        public void getValue(Enum item, ref Double value, Endians endian = Endians.Little)
        {
            value = getValueFloat(item, endian);
        }
        public void getValue(Enum item, ref Boolean value)
        {
        ...
        /// <param name="endian"></param>
        /// <returns></returns>
        public Double getValueFloat(Enum item, Endians endian= Endians.Little)
        {
            int startOffset = 0;
            int byteSize = 0;
            int bitStart = -1;
