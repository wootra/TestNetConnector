...
{
    public class EasyGridTextBoxColumn:DataGridViewTextBoxColumn, IEasyGridColumn
    {
        public EasyGridTextBoxColumn(EasyGridViewParent parent)
            : base()
        {
            this.CellTextAlignMode = _cellTextAlignMode;
            _headerCell = new EasyGridHeaderCell(base.HeaderCell);
            this.CellTemplate = new EasyGridTextBoxCell(parent);
