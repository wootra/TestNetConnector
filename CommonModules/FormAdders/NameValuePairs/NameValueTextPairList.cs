...
{
    public partial class NameValueTextPairList : UserControl
    {
        private int valueX = 30;
        List<Label> names = new List<Label>();
        List<String> nameString = new List<string>();
        List<NumberTextBox> values = new List<NumberTextBox>();
        Dictionary<String, NumberTextBox> valueDic = new Dictionary<string, NumberTextBox>();
        Boolean isInit = true;
        ...
        #region U_TextBoxBorderStyle
        BorderStyle _textBoxBorderStyle = BorderStyle.None;
        [SettingsBindable(true)]
        [Browsable(true)]
        public BorderStyle U_TextBoxBorderStyle
        {
            get
            {
            ...
            set
            {
                _textBoxBorderStyle = value;
                for (int i = 0; i < values.Count; i++)
                {
                    values[i].BorderStyle = _textBoxBorderStyle;
                }
                //base.BackColor = value;
                Refresh();
            }
        ...
        public NumberTextBox this[int index]
        {
            get { try { return values[index]; } catch { return null; } }
        }

        public NumberTextBox this[String name]
        {
            get { try { return valueDic[name]; } catch { return null; } }
        }

        public NumberTextBox getValueTextBox(String name)
        {
            return valueDic[name];
        }

        public List<NumberTextBox> getValueTextBoxList()
        {
            return values;
        }
        ...
        public NumberTextBox makeTextBox(int x, int y, String initValue,String name)
        {
            NumberTextBox textBox = new NumberTextBox();
            textBox.BorderStyle = _textBoxBorderStyle;
        ...
        public String[] U_Keys
        {
            get
            {
                return valueDic.Keys.ToArray();
            }
        }
