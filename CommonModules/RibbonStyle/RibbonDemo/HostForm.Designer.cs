namespace RibbonDemo
{
   partial class HostForm
   {
      ...
      private void InitializeComponent()
      {
         ...
         // ribbonLabel4
         // 
         this.ribbonLabel4.AltKey = null;
         this.ribbonLabel4.Image = null;
         this.ribbonLabel4.LabelWidth = 130;
         this.ribbonLabel4.Tag = null;
         ...
         this.ribbonLabel4.ToolTip = null;
         this.ribbonLabel4.ToolTipImage = null;
         this.ribbonLabel4.ToolTipTitle = null;
         this.ribbonLabel4.Value = null;
         // 
         // ribbonLabel1
         // 
         this.ribbonLabel1.AltKey = null;
         this.ribbonLabel1.Image = null;
         ...
         this.ribbonLabel1.ToolTip = null;
         this.ribbonLabel1.ToolTipImage = null;
         this.ribbonLabel1.ToolTipTitle = null;
         this.ribbonLabel1.Value = null;
         // 
         // ribbonComboBox1
         // 
         ...
         // ribbonHost2
         // 
         this.ribbonHost2.AltKey = null;
         this.ribbonHost2.HostedControl = this.month1;
         this.ribbonHost2.Image = null;
         this.ribbonHost2.Tag = null;
         this.ribbonHost2.Text = null;
         this.ribbonHost2.ToolTip = null;
         this.ribbonHost2.ToolTipImage = null;
         this.ribbonHost2.ToolTipTitle = null;
         this.ribbonHost2.Value = null;
         // 
         // ribbonPanel1
         // 
         ...
         // ribbonLabel2
         // 
         this.ribbonLabel2.AltKey = null;
         this.ribbonLabel2.Image = null;
         this.ribbonLabel2.LabelWidth = 120;
         this.ribbonLabel2.Tag = null;
         ...
         this.ribbonLabel2.ToolTip = null;
         this.ribbonLabel2.ToolTipImage = null;
         this.ribbonLabel2.ToolTipTitle = null;
         this.ribbonLabel2.Value = null;
         // 
         // ribbonLabel3
         // 
         this.ribbonLabel3.AltKey = null;
         this.ribbonLabel3.Image = null;
         this.ribbonLabel3.LabelWidth = 120;
         this.ribbonLabel3.Tag = null;
         ...
         this.ribbonLabel3.ToolTip = null;
         this.ribbonLabel3.ToolTipImage = null;
         this.ribbonLabel3.ToolTipTitle = null;
         this.ribbonLabel3.Value = null;
         // 
         // ribbonHost1
         // 
         this.ribbonHost1.AltKey = null;
         this.ribbonHost1.HostedControl = this.dateTimePicker1;
         this.ribbonHost1.Image = null;
         ...
         this.ribbonHost1.Tag = null;
         this.ribbonHost1.Text = null;
         this.ribbonHost1.ToolTip = null;
         this.ribbonHost1.ToolTipImage = null;
         this.ribbonHost1.ToolTipTitle = null;
         this.ribbonHost1.Value = null;
         // 
         // ribbonPanel2
         // 
         ...
         // ribbonHost3
         // 
         this.ribbonHost3.AltKey = null;
         this.ribbonHost3.HostedControl = this.dataGridView1;
         this.ribbonHost3.Image = null;
         ...
         this.ribbonHost3.Tag = null;
         this.ribbonHost3.Text = "Grid Host";
         this.ribbonHost3.ToolTip = null;
         this.ribbonHost3.ToolTipImage = null;
         this.ribbonHost3.ToolTipTitle = null;
         this.ribbonHost3.Value = null;
