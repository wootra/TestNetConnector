...
namespace DBHandling
{
    ...
    public class ODBCHandler
    {
        ...
        public string OdbcConnStr(string db_name, String url="(local)", String password = "")
        {
            ...
            string mdbConnText = @"Server="+url+"\\;Database="+db_name+";Trusted_Connection=" + trusted;// +mdbFilePath + ".mdb;";
            if(password!=null && password.Length>0) mdbConnText+= ";uid=admin;password="+password+";";
            return (string)mdbConnText;
        }


        public void ConnectToDb(String db_name, String url="(local)", String password="")
        {
            _conn = new  OdbcConnection(OdbcConnStr(db_name, url, password));
        ...
        public void CreateTable(String TableName, params string[] fieldsAndOptions)
        {
            ...
            query += ");";
            _cmd = new OdbcCommand(query, _conn);
        ...
        public DataTable getQueryResult(String OdbcQuery, String tableName=null)
        {
            _cmd = new OdbcCommand();
            _cmd.Connection = _conn;
            _cmd.CommandType = CommandType.Text;
            ...
            OdbcDataAdapter dataAddapter = new OdbcDataAdapter(_cmd);
            OdbcCommandBuilder commandBuider = new OdbcCommandBuilder(dataAddapter);
