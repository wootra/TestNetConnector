...
namespace DBHandling
{
    ...
    public class SQLHandler
    {
        ...
        public string SqlConnStr(string db_name, String url="(local)", String password = "")
        {
        ...
        {
            _conn = new  SqlConnection(SqlConnStr(db_name, url, password));
        ...
        public DataTable getQueryResult(String sqlQuery, String tableName=null)
        {
            ...
            SqlDataAdapter dataAddapter = new SqlDataAdapter(_cmd);
            SqlCommandBuilder commandBuider = new SqlCommandBuilder(dataAddapter);
