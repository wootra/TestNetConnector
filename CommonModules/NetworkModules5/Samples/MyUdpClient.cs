...
namespace NetworkModules5.Samples
{
    public class MyUdpClient
    {
        ...
        public MyUdpClient()
        {
                _localEP = new IPEndPoint(Dns.GetHostEntry("192.168.1.127").AddressList[0], IPEndPoint.MinPort + 1);
        ...
        {
            _remoteEP = new IPEndPoint(Dns.GetHostEntry(IP).AddressList[0], port);
