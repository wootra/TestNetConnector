...
{
    public class IXmlItemBase: IXmlItem
    {
        public IXmlItemBase()
        {
        }
        ...
        public void LoadXml(String xmlFile, Boolean refLoad = false)
        {
            ...
            {
                MessageBox.Show("IXmlItemBase.XmlSchemaValidation:" + e.Message + ":" + xmlFile);
            }
        }
        ...
        {
            MessageBox.Show("IXmlItemBase.XmlSchemaValidation:" + e.Message);
        }
